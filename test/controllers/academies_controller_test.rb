...
class AcademiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create academy" do
    assert_difference('Academy.count') do
      post academies_url, params: { academy: { academy_id: @academy.academy_id, name: @academy.name } }
    end
  ...
  test "should update academy" do
    patch academy_url(@academy), params: { academy: { academy_id: @academy.academy_id, name: @academy.name } }
